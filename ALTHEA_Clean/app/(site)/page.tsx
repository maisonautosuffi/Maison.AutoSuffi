        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(300px, 100%), 1fr))', gap: '5rem', alignItems: 'center' }}>
            <div style={{ minWidth: 0 }}>
              <h2 className="reveal-text" style={{ fontSize: 'clamp(2.4rem, 10vw, 3rem)', marginBottom: '2rem', color: 'var(--color-text-primary)', overflowWrap: 'anywhere' }}>Vision <br /> Architecturale</h2>
